...
class BuildTest(unittest.TestCase):
    ...
    def test_build_outputs_aligned_style_static_site(self):
        ...
        self.assertEqual(html.count('class="story-card"'), 15)
        self.assertEqual(html.count('class="story-section"'), 15)
        self.assertEqual(html.count('class="story-source-label"'), 15)
